  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: -1 }}>
      ...
      <div style={{
        ...
        width: '100%',
        height: '100%',
        backdropFilter: 'blur(100px) brightness(0.8) saturate(1.4)', // Heavy blur + darken + saturate
        WebkitBackdropFilter: 'blur(100px) brightness(0.8) saturate(1.4)', // Safari support
        zIndex: 1
      }} />
    </div>
  );
